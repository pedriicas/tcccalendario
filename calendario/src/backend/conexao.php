...
$usuario = "cl202149"; // Usuário do banco de dados
$senha = "cl22082006"; // Senha do usuário (vazia no XAMPP padrão)
$nomeBanco = "cl202149"; // Nome do banco de dados que vamos usar
